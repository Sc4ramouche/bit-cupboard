...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for player_card in player.deck.cards:
            player_card.attack += other_card.attack
            player_card.defense += other_card.defense

        opponent.deck.cards = [card for card in opponent.deck.cards if other_card.attack !=
                               card.attack or other_card.defense != card.defense]
